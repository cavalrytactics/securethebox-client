				...
				<form>
					<Grid container spacing={3} direction="row" justify="center" alignItems="flex-start" >
						...
						<Grid item xs={10} sm={3}>
							<Button className={classes.button} onClick={() => updateCourse(values.ID)}>Start</Button>
						</Grid>
					</Grid>
				</form >
			</Paper >
...
export default withReducer('auth', reducer)((connect(mapStateToProps)(ViewCourse)));